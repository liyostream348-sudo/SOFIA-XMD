...
const ownerNumber = ['94771675223']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.split("SOFIYA - XMD~")[1];
...
console.log("Connecting 𝐒𝐎𝐅𝐈𝐘𝐀 - 𝐗𝐌𝐃 Bot.....🔥");
...
console.log('𝐒𝐎𝐅𝐈𝐘𝐀 - 𝐗𝐌𝐃 Bot connected to whatsapp ✅')

let up = `*Connecting 𝐒𝐎𝐅𝐈𝐘𝐀 - 𝐗𝐌𝐃 Multidevice Whatsapp Bot ...💾*


*😈 : 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐄𝐋*
*╭┈───────────╴╴╴•⟢*
*│https://whatsapp.com/channel/0029VbAVlMW8vd1TCTvZAE2D
*╰┈───────────╴╴╴•⟢*
*😈 : 𝐂𝐎𝐍𝐓𝐀𝐂𝐓*
*╭┈───────────╴╴╴•⟢*
*│wa.me/94771675223
...
conn.sendMessage(conn.user.id,{ image: { url: `https://files.catbox.moe/395pc1.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94771675223")){
if(isReact) return
m.react("👨‍💻")
}
